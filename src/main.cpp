...
uint256 hashGenesisBlock("0x47778e4226f2195c0f8225b91c2aef2ac3ada57df78db7dcb0667b298f9f3e6c");
...
const string strMessageMagic = "vgacoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // vgacoin: 1 days
static const int64 nTargetSpacing = 120; // vgacoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal vgacoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "vgacoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xbbe109054f1c783abfc8a8210df263e573f53266188e2629fa7b6a85405b494b");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Tek was bored one night and made this.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1390274345; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 175427;

        if (fTestNet)
        {
            block.nTime    = 1390269812;
            block.nNonce   = 426540;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x77fd4879fd426ffb12d8851bff20804762366e5c3981c44729731233f585291c"));
